...
const resources = {
  en: {
    translation: {
      ...
      ontarioOathText:
        'I shall not pervert the law to favour or prejudice any one, but in all things I shall conduct myself honestly and with integrity and civility. <strong>I shall champion the rule of law and safeguard the rights and freedoms of all persons.</strong>',
      ...
      weAreCanadianLawyers:
        'We are Canadian lawyers. Consistent with our oath, we are guardians, protectors and a voice for the Rule of Law in Canada. Today, we stand together in solidarity to re-affirm our duty to vigorously and unwaveringly defend the Rule of Law in Canada.',
      pledgeToReaffirm:
      ...
      yourEmailNote:
        '(Note that email addresses provided here will not be published on the website)',
      province: 'Province',
      receiveUpdatesText:
  ...
  fr: {
    translation: {
      ...
      ontarioOathText:
        ' Je ne détournerai pas la loi pour favoriser ou désavantager qui que ce soit, mais je me conduirai en tout temps avec honnêteté, intégrité et civilité. <strong>Je défendrai la primauté du droit et protégerai les droits et libertés de toutes les personnes.</strong>',
      ...
      statementByChiefJustices:
        'Déclaration des juges en chef des tribunaux de l’Alberta',
      ...
      yourEmailNote:
        '(Notez que les courriels fournis ici ne seront pas publiés sur le site)',
      province: 'Province',
      receiveUpdatesText:
